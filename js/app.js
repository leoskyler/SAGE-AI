...
// This points directly to your newly deployed secure Render backend!
const BACKEND_URL = "https://sage-ai-backend-d0el.onrender.com/api/chat";
...
/* ==========================
   GEMINI (UPDATED SECURE CALL)
========================== */

async function generateReply(message) {
    // System Instruction builds details about the user for SAGE AI
...
`;
    ...
    // We send a request to your Render server rather than calling Google directly
...
async function sendMessage() {
    ...
    try {
        ...
        loading.remove();
        addMessage(
            "❌ Failed to contact SAGE helper server.",
            "ai"
        );
    }
}
...
function saveCurrentChat() {
    ...
    localStorage.setItem("sageChats", JSON.stringify(chats));
    renderChatHistory();
}
